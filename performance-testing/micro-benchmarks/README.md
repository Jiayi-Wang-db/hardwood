...
| `FooterQuerySweep` | Full zero-row query time across projection widths and filter shapes, isolating footer work for three representations | four-file corpus from `parquet-footer-bench` |
